//
//  BLCPostToInstaramViewController.m
//  Blocstagram
//
//  Created by Brandon Wade on 9/26/15.
//  Copyright (c) 2015 Brandon Wade. All rights reserved.
//

#import "BLCPostToInstaramViewController.h"

@interface BLCPostToInstaramViewController () <UICollectionViewDataSource, UICollectionViewDelegate, UIAlertViewDelegate, UIDocumentInteractionControllerDelegate>
...
@implementation BLCPostToInstaramViewController
...
- (NSAttributedString *) sendAttributedString {
    NSString *baseString = NSLocalizedString(@"Send to Instagram", "Send button text");
...
- (void) addFiltersToQueue {
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        CIFilter *tiltFilter = [CIFilter filterWithName:@"CIStraigtenFilter"];
        ...
        if (drunkFilter ) {
            ...
            if (tiltFilter) {
                ...
                [tiltFilter setValue:@0.2 forKey:kCIInputImageKey];
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (invertFilter) {
            ...
            [self addCIImageToCollectionView:invertFilter.outputImage withFilterTitle:NSLocalizedString(@"Invert", @"Color Invert")];
        }
    }];
    ...
    [self.photoFilterOperationQueue addOperationWithBlock:^{
        ...
        if (chromeFilter ) {
            ...
            CIImage *result = chromeFilter.outputImage;
            ...
            [self addCIImageToCollectionView:result withFilterTitle:NSLocalizedString(@"Bright", @"Bright filter")];
        }
    }];
